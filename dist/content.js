...
(function () {
    ...
    function enableEnterKeyGuard() {
        ...
        window.addEventListener("keydown", (e) => {
            ...
            console.log(`[CGTN] KeyDown: Enter | Method: ${method} | Shift: ${e.shiftKey} | Ctrl: ${e.ctrlKey} | Alt: ${e.altKey}`);
            // 1. 設定チェック
            if (method === "enter") {
            ...
            console.log(`[CGTN] Decision: ${isSend ? "SEND (Pass through)" : "NEWLINE (Block & Insert)"}`);
            // 送信キーならスルー
            if (isSend)
                return;
            // --- 改行処理 ---
