...
(() => {
    ...
    const DICT = {
        ja: {
            ...
            "options.pinsHint": "各チャットの付箋一覧。不要になったチャットは削除できます。",
            "options.thChat": "チャット",
            "options.thTurns": "会話数",
            "options.thCount": "付箋数",
            ...
            "opts.subtips": "送信キーの設定変更や、エクスポート／インポートによるバックアップにも対応しています。",
            "opts.lang.ja": "日本語",
            ...
            "opts.backupDesc": "付箋データをJSONファイルにエクスポートまたはバックアップから復元します。",
            "opts.importConfirm": "現在のデータを上書きしてインポートしますか？\n(この操作は取り消せません)",
        ...
        en: {
            ...
            "opts.tips": "Configure navigation, display preferences, and data management.",
            "opts.subtips": "Supports export/import backup and customizable send key settings.",
            "opts.lang.ja": "日本語",
            "opts.lang.en": "English",
            ...
            "opts.backupDesc": "Export your pins and settings to a JSON file, or restore from a backup.",
            "opts.importConfirm": "Do you want to overwrite current data and import?\n(This action cannot be undone.)",
