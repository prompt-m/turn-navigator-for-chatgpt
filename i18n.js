...
(() => {
  ...
  const DICT = {
    ja: {
      ...
      'list.footer.pinOnly': '会話数: {count}/{total}｜アップロード: {uploads}｜ダウンロード・リンク: {downloads}',
      'list.footer.all':     '会話数: {total}｜アップロード: {uploads}｜ダウンロード・リンク: {downloads}',
    ...
    en: {
      ...
      'list.footer.pinOnly': 'Turns: {count}/{total} | Uploads: {uploads} | Downloads / Links: {downloads}',
      'list.footer.all': 'Turns: {total} | Uploads: {uploads} | Downloads / Links: {downloads}',
