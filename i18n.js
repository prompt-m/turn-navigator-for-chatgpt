...
(() => {
  ...
  const DICT = {
    ja: {
      ...
      'list.footer.pinOnly': '会話数; {count} / {total}',
      'list.footer.all':     '会話数; {total}',
      'listRows': "行",
      'listTurns': "ターン",
      'preview': "プレビュー",
      'preview.title': "プレビュー",
      'attachments': "添付",
      // ===== 設定画面（options.*） =====
      'options.pinsTitle': 'チャット一覧（付箋データ管理）',
    ...
    en: {
      ...
      'list.footer.pinOnly': 'Count; {count} / {total}',
      'list.footer.all':     'Count; {total}',
      'listRows': "rows",
      'listTurns': "turns",
      'preview': "Preview",
      ...
      'options.pinsTitle': 'Chats(Pinned Data)',
